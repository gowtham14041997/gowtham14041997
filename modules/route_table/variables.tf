...
variable "private_subnet_ids_count" {
  type          = number
  description   = "Number of private subnets to associate with route table"
}

variable "private_subnet_ids" {
  type          = list(string)
  description   = "IDs of private subnets to associate with route table"
}
